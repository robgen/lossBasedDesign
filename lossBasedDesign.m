classdef lossBasedDesign
    ...
    methods % macro-methods
        ...
        function self = lossBasedDesign(options)
        ...
        function self = getSeedMAFEds(self)
            ...
            for n = numel(self.fy): -1 : 1
                ...
                hazCurve = [0, haz.faultRate; ...
                    intHaz', haz.MAFEhazard(:)];
                
                self.mafeDS(n,:) = self.calculateMAFEds(self.fragMedian(n,:), ...
                    self.fragStDev(n,:), hazCurve);
            end
        end
        ...
        function self = getFrameMemberDetailing(self)
            
            frame = self.parameters.Frame;
            
            g = 9.81;
            massesOneFrame = frame.masses/frame.Nparallel;
            
            DeffNC = self.pushDesign(3,1);
    ...
    methods(Access = 'private')
        ...
        function self = setAllParameters(self, options)
            ...
            microFieldsPar{4} = {'fc' 'fct' 'epsYsteel', 'lengthBeam', 'heightBeam', ...
                'heightColumn', 'Nparallel', 'masses', 'Nstoreys', 'Nbays', ...
                'heightInterstorey', 'gammaMomentCols', 'limitBeams'};
        ...
        function self = frameDBDgeneral(self, manualDeltaYield)
            ...
            if numel(frame.heightInterstorey) == 1
                frame.heightInterstorey = frame.heightInterstorey * ...
                    ones(frame.Nstoreys,1);
            end
            
            if numel(frame.masses) == 1
                frame.masses = frame.masses * ...
                    ones(frame.Nstoreys,1);
            end
            
            frame.heightStorey = cumsum(frame.heightInterstorey);
        ...
        function self = setSeedSDoFproperties(self)
            ...
            self.T = 2*pi * ...
                (self.parameters.Frame.deltaYield ./ (self.FY*9.81)).^0.5;
        ...
        function self = collectDesignProperties(self, selectedSDoF)
            ...
            self.propDesign.dispThresholds = ...
                ...
                self.parameters.Frame.deltaYield;
